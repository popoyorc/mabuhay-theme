...
.btn {
  ...
  .btn:focus, .btn.focus {
    outline: 0;
    box-shadow: 0 0 0 0.2rem rgba(24, 101, 251, 0.25); }
  ...
  .btn:not(:disabled):not(.disabled):active, .btn:not(:disabled):not(.disabled).active {
    ...
    .btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
      box-shadow: 0 0 0 0.2rem rgba(24, 101, 251, 0.25), inset 0 0 transparent; }
...
.btn-primary {
  ...
  .btn-primary:focus, .btn-primary.focus, .form-file-input:focus + .btn-primary {
    box-shadow: none, 0 0 0 0.2rem rgba(24, 101, 251, 0.5); }
  ...
  .show > .btn-primary.dropdown-toggle {
    ...
    .show > .btn-primary.dropdown-toggle:focus {
      box-shadow: inset 0 0 transparent, 0 0 0 0.2rem rgba(24, 101, 251, 0.5); }
...
.btn-outline-primary {
  ...
  .btn-outline-primary:focus, .btn-outline-primary.focus {
    box-shadow: 0 0 0 0.2rem rgba(24, 101, 251, 0.5); }
...
.custom-control-input {
  ...
  .custom-control-input:focus ~ .custom-control-label::before {
    box-shadow: 0 0 0 1px #F1F2F5, 0 0 0 2px #80abff; }
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(24, 101, 251, 0.5); }
...
.custom-select {
  ...
  .custom-select:focus {
    border-color: #80abff;
    outline: 0;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(128, 171, 255, 0.5); }
...
.navbar-brand {
  display: inline-block;
  padding-top: 0.57812rem;
  padding-bottom: 0.57812rem;
  margin-right: 1rem;
  font-size: 0.9375rem;
  line-height: inherit;
  white-space: nowrap; }
...
.bg-primary {
  background-color: #1865FB !important; }

a.bg-primary:hover, a.bg-primary:focus,
button.bg-primary:hover,
button.bg-primary:focus {
  background-color: #044ddc !important; }
...
.text-primary {
  color: #1865FB !important; }

a.text-primary:hover, a.text-primary:focus {
  color: #044ddc !important; }
...
.btn-sm, .btn-group-sm > .btn, .btn-group-sm .btn-group > .btn {
  font-size: 0.8125rem; }
  .btn-sm .inline-item, .btn-group-sm > .btn .inline-item, .btn-group-sm .btn-group > .btn .inline-item {
    font-size: 0.875rem; }
...
.btn-primary:focus, .btn-primary.focus, .form-file-input:focus + .btn-primary {
  background-color: #0051f0;
  border-color: transparent;
  box-shadow: 0 0 0 2px rgba(0, 81, 240, 0.5); }
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  background-color: #f0f5ff;
  box-shadow: 0 0 0 2px rgba(0, 81, 240, 0.25);
  color: #1865FB; }
...
.form-file-input {
  ...
  .form-file-input:focus + .input-group {
    border-radius: 1px;
    box-shadow: 0 0 0 0.075rem #FFF, 0 0 0 0.2rem rgba(24, 101, 251, 0.25); }
...
.collapse-icon .collapse-icon-open {
  ...
  position: absolute;
  right: 0.9375rem;
  top: calc(0.625rem + 0.0625rem + (((0.875rem * 1.5) - 1em) / 2));
  width: 1em; }
...
.input-group-sm .input-group-item .btn {
  font-size: 0.8125rem; }
  .input-group-sm .input-group-item .btn .inline-item {
    font-size: 0.875rem; }
...
.list-group-notification .list-group-item-primary {
  ...
  border-bottom-left-radius: 0;
  border-top-left-radius: 0;
  box-shadow: inset 0.5rem 0 #80abff, inset -0.0625rem 0 rgba(220, 220, 220, 0.5), inset 0 0.0625rem rgba(220, 220, 220, 0.5), inset 0 -0.0625rem rgba(220, 220, 220, 0.5); }
...
.modal .close {
  ...
  width: 2rem;
  opacity: 1; }
  .modal .btn-monospaced:hover, .modal .btn-monospaced:focus,
  .modal .close:hover,
  .modal .close:focus {
    opacity: 1; }
...
.management-bar {
  ...
  .management-bar .navbar-brand {
    font-size: 0.9375rem;
    margin-right: 0;
    padding-bottom: 0.76562rem;
    padding-left: 0.25rem;
    padding-right: 0.25rem;
    padding-top: 0.76562rem; }
  ...
  @media (min-width: 576px) {
    .management-bar.navbar-expand-sm .navbar-brand {
      font-size: 0.9375rem;
      margin-right: 0.5rem;
      padding-bottom: 1.26562rem;
      padding-left: 0.5rem;
      padding-right: 0.5rem;
      padding-top: 1.26562rem; }
    .management-bar.navbar-expand-sm .navbar-form {
      height: 3.9375rem;
      padding-left: 0.5rem;
      padding-right: 0.5rem; }
...
.panel-header {
  ...
  .panel-header .collapse-icon-open {
    font-size: 0.875rem;
    top: calc(0.75rem + (((0.875rem * 1.2) - 1em) / 2)); }
...
.sheet-subtitle {
  ...
  .sheet-subtitle .collapse-icon-open {
    top: calc(0.5rem + (((0.8125rem * 1.2) - 1em) / 2)); }
...
.sidebar-header .component-title {
  ...
  .sidebar-header .component-title a {
    color: #272833; }
    .sidebar-header .component-title a:hover {
      color: #060608; }
...
.table-list.table-bordered {
  ...
  .table-list.table-bordered td {
    box-shadow: inset 0 0.0625rem #e7e7ed, inset -0.0625rem 0 #e7e7ed, 0 0.0625rem #e7e7ed, -0.03125rem 0.03125rem 0 0.03125rem #e7e7ed;
    padding-right: 0.8125rem;
    padding-top: 0.8125rem; }
